            ...
            return (
              ...
              >
                {snakeAndLadderHeadsAndTails.snakeHeads?.has(labelNumber) ? (
                  <SnakeOrLadderBlock
                    inputNumber={
                      snakeAndLadderHeadsAndTails.snakeHeads?.get(
                        labelNumber
                      ) ?? 0
                    }
                ...
                {snakeAndLadderHeadsAndTails.snakeTails?.has(labelNumber) ? (
                  <SnakeOrLadderBlock
                    inputNumber={
                      snakeAndLadderHeadsAndTails.snakeTails?.get(
                        labelNumber
                      ) ?? 0
                    }
                ...
                {snakeAndLadderHeadsAndTails.ladderHeads?.has(labelNumber) ? (
                  <SnakeOrLadderBlock
                    inputNumber={
                      snakeAndLadderHeadsAndTails.ladderHeads?.get(
                        labelNumber
                      ) ?? 0
                    }
                ...
                {snakeAndLadderHeadsAndTails.ladderTails?.has(labelNumber) ? (
                  <SnakeOrLadderBlock
                    inputNumber={
                      snakeAndLadderHeadsAndTails.ladderTails?.get(
                        labelNumber
                      ) ?? 0
                    }
